...
export function Footer() {
  ...
  return (
    <footer className="border-t bg-muted/20 pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 mb-10">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              KI-gestützte Simultanübersetzung für Live-Events.
              Bring your own API Key — kostenlos, offen, datenschutzfreundlich.
            </p>
            ...
            <div className="mt-4">
              <a
                href="https://www.swissmadesoftware.org/companies/liitu-consulting-gmbh/home.html"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center"
              >
                <img src="/icons/swiss-made-software.png" alt="Swiss Made Software" className="h-10" />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <button onClick={() => scrollTo("#demo")} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Live Demo
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => scrollTo("#providers")} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Anbieter
                </button>
              </li>
            </ul>
          ...
          {/* Soziale Medien */}
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4">Soziale Medien</h3>
            <ul className="space-y-2.5">
          ...
          {/* Rechtliches */}
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4">Rechtliches</h3>
            <ul className="space-y-2.5">
        ...
        <div className="border-t border-border pt-6">
          <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between">
            <p className="text-xs text-muted-foreground">
              &copy; {new Date().getFullYear()} LinguAI by{" "}
              <a
                href="https://www.liitu.ch"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-foreground transition-colors"
              >
                liitu consulting gmbh
              </a>
              . Lizenziert unter{" "}
              <a
            ...
            <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
              ...
              <span>
                CO<sub>2</sub>-Rating: <strong className="text-emerald-500">A+</strong> — sauberer als 96% aller Webseiten — nur 0.02g CO<sub>2</sub>/Besuch
              </span>
            </div>
          </div>
        </div>
